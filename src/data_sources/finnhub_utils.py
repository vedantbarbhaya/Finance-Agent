...
if __name__ == "__main__":
    ...
    register_keys_from_json("/Users/vedantbarbhaya/Desktop/Cursor projects/Finance-Agent-Sytem/config_api_keys.json")
    ...
    #print(FinnHubUtils.get_company_news("NVDA", "2023-12-01", "2023-12-31")) # only 1 year back from the current date
