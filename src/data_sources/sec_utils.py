...
from src.utils import SavePathType, decorate_all_methods
from src.data_sources import FMPUtils
...
if __name__ == "__main__":
    print(SECUtils.download_10k_pdf("AAPL", "2023-01-01", "2024-01-01", "10k_pdf"))